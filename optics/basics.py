...
class Material(PrettyPrinter):
    ...
    def __init__(self, name=None):
        ...
        self.MATERIAL_TABLE = { # [nD, Abbe number]
            "vacuum":     [1.,       math.inf],
            "air":        [1.000273, math.inf],    # [1.000293, math.inf],
            "occluder":   [1.,       math.inf],
            "f2":         [1.620,    36.37],
            "f15":        [1.60570,  37.831],
            "uvfs":       [1.458,    67.82],
            ...
            "n-bk7":      [1.51680,  64.167],         # [1.51680,  64.17],  64.167   66.95
            "n-sf1":      [1.71736,  29.62],
            "n-sf2":      [1.64769,  33.82],
            "n-sf4":      [1.75513,  27.38],
            "n-sf5":      [1.67271,  32.25],
            ...
            "sf6":        [1.80518,  25.43],
            "sf18":       [1.72150,  29.245],
            "h-k9l":       [1.5168,  64.212],     # [1.5168,  64.212],   67.1
    ...
    def ior(self, wavelength):
        ...
        AAA = self.A + self.B / wavelength**2
